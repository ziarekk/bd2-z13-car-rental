...
public interface CarRepository extends JpaRepository<Car, Long> {
    ...
    void insertCar(@Param("mileage") Integer mileage, 
                   ...
                   @Param("fuelLevel") Float fuelLevel, 
